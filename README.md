...
- R&D-фокус: люблю исследовательские ML-задачи на стыке с наукой, начиная от гипотез и дизайна экспериментов, заканчивая валидацией на шумных данных со смещениями и небольшими выборками.
